          ...
          <div key={index} className="post1 my-5 w-3/4 flex flex-col shadow-sm shadow-zinc-300 p-4 rounded">
            ...
            <User size={30} color="#ffffff" />
              ...
              <div className="user-text ml-2 ">
                <h2 className="text-white font-extrabold">{post.firstName} {post.lastName}</h2>
                <p className="text-zinc-400 text-xs leading-none">Posted at {new Date(post.createdAt).toLocaleString()}</p>
              </div>
            </div>
